...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 黑风寨主·赵横 | 山匪头领 | 800 | 1.2×玩家 | 2 | 横扫+冲锋 | 精钢刀、200金 |
| 2 | 血禅师 | 断魂谷邪教首领 | 1200 | 1.3×玩家 | 2 | 召唤+毒域 | 雁翎刀、300金 |
| 3 | 铸剑老人·欧阳冶 | 铸剑山庄庄主 | 1800 | 1.5×玩家 | 3 | 熔炉场地+重击 | 玄铁重刀、破镜重圆、400金 |
| 4 | 神刀门主·司马烈 | 神刀门掌门 | 2600 | 1.8×玩家 | 3 | 双刀+刀阵 | 龙鳞刀、500金 |
| 5 | 伪盟主·冷无缺 | 篡位武林盟主 | 3600 | 2.0×玩家 | 3 | 影分身+禁刀域 | 虎啸狂刀、800金 |
| 6 | 武林盟主·天绝老人 | 最终Boss | 5000 | 2.2×玩家 | 4 | 全机制综合 | 屠龙刀/藏锋·无名、1000金、结局 |
...
**阶段2（55%-0%）**：召唤2只血刀僧协助 + 血刀斩（远程弧形刀光，可被拼刀抵消）
...
```mermaid
graph LR
    A[关1 赵横<br/>HP800 动量1.2×<br/>教学型] --> B[关2 血禅师<br/>HP1200 动量1.3×<br/>召唤+毒]
    B --> C[关3 欧阳冶<br/>HP1800 动量1.5×<br/>场地机制]
    C --> D[关4 司马烈<br/>HP2600 动量1.8×<br/>双刀+刀阵]
    D --> E[关5 冷无缺<br/>HP3600 动量2.0×<br/>分身+禁刀域]
    E --> F[关6 天绝老人<br/>HP5000 动量2.2×<br/>4阶段综合]
```

难度递进维度：HP、动量、阶段数、机制复杂度同步上升。

## 6. Boss 战时长测算

以玩家关n预期DPS测算（见 [平衡性分析](../06-balance/平衡性分析.md)）：

| Boss | HP | 玩家DPS(关n) | 纯输出时长 | 实际时长(含走位/拼刀) |
| --- | --- | --- | --- | --- |
| 赵横 | 800 | 60 | 13s | 60-75s |
| 血禅师 | 1200 | 85 | 14s | 65-80s |
| 欧阳冶 | 1800 | 115 | 16s | 75-90s |
| 司马烈 | 2600 | 150 | 17s | 80-95s |
| 冷无缺 | 3600 | 190 | 19s | 85-100s |
| 天绝老人 | 5000 | 240 | 21s | 90-110s |
